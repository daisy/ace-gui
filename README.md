...
The latest version of Ace App is `v1.1.4`. Please visit the [release page](https://github.com/daisy/ace-gui/releases/tag/v1.1.4) for more information.
...
* **MacOS**: download the [DMG file](https://github.com/daisy/ace-gui/releases/download/v1.1.4/Ace.by.DAISY-1.1.4.dmg), open it, and drag the `Ace by DAISY.app` file into your Applications folder.
* **Windows**: download the [NSIS installer](https://github.com/daisy/ace-gui/releases/download/v1.1.4/Ace.by.DAISY.Setup.1.1.4.exe), and follow the step-by-step instructions.
* **Linux**: download the [AppImage file](https://github.com/daisy/ace-gui/releases/download/v1.1.4/Ace.by.DAISY-1.1.4.AppImage), and double-click the icon to immediately start using the application. Alternatively, you may download the [Debian package](https://github.com/daisy/ace-gui/releases/download/v1.1.4/ace-gui_1.1.4_amd64.deb) to install the app via your package manager (e.g. `sudo apt install ace-gui_1.1.4_amd64.deb`).
