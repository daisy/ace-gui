...
The latest version of Ace App is `v1.0.1`. Please visit the [release page](https://github.com/daisy/ace-gui/releases/tag/v1.0.1) for more information.
...
* **MacOS**: download the [DMG file](https://github.com/daisy/ace-gui/releases/download/v1.0.1/Ace.by.DAISY-1.0.1.dmg), open it, and drag the `Ace by DAISY.app` file into your Applications folder.
* **Windows**: download the [NSIS installer](https://github.com/daisy/ace-gui/releases/download/v1.0.1/Ace.by.DAISY.Setup.1.0.1.exe), and follow the step-by-step instructions. Please ignore the security warning messages, they are due to the application [not being signed yet](https://github.com/daisy/ace-gui/issues/15).
* **Linux**: download the [AppImage file](https://github.com/daisy/ace-gui/releases/download/v1.0.1/Ace.by.DAISY-1.0.1.AppImage), and double-click the icon to immediately start using the application. Alternatively, you may download the [Debian package](https://github.com/daisy/ace-gui/releases/download/v1.0.1/ace-gui_1.0.1_amd64.deb) to install the app via your package manager (e.g. `sudo apt install ace-gui_1.0.1_amd64.deb`).
