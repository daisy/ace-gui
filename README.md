...
The latest version of Ace App is `v1.4.6`. Please visit the [release page](https://github.com/daisy/ace-gui/releases/tag/v1.4.6) for more information.
...
* **MacOS** (Intel x64): download the [DMG file](https://github.com/daisy/ace-gui/releases/download/v1.4.6/Ace.by.DAISY-1.4.6.dmg), open it, and drag the `Ace by DAISY.app` file into your Applications folder.
* **MacOS** (Apple Silicon arm64 M1/M2/M3/M4): download the [DMG file](https://github.com/daisy/ace-gui/releases/download/v1.4.6/Ace.by.DAISY-1.4.6-arm64.dmg), open it, and drag the `Ace by DAISY.app` file into your Applications folder.
* **Windows** (Intel x64): download the [NSIS installer](https://github.com/daisy/ace-gui/releases/download/v1.4.6/Ace.by.DAISY.Setup.1.4.6.exe), and follow the step-by-step instructions.
* **Windows** (arm64): download the [NSIS installer](https://github.com/daisy/ace-gui/releases/download/v1.4.6/Ace.by.DAISY.Setup.1.4.6-arm64.exe), and follow the step-by-step instructions.
* **Linux** (Intel x64): download the [AppImage file](https://github.com/daisy/ace-gui/releases/download/v1.4.6/Ace.by.DAISY-1.4.6.AppImage), and double-click the icon to immediately start using the application. Alternatively, you may download the [Debian package](https://github.com/daisy/ace-gui/releases/download/v1.4.6/ace-gui_1.4.6_amd64.deb) to install the app via your package manager (e.g. `sudo apt install ace-gui_1.4.6_amd64.deb`).
* **Linux** (arm64): download the [AppImage file](https://github.com/daisy/ace-gui/releases/download/v1.4.6/Ace.by.DAISY-1.4.6-arm64.AppImage), and double-click the icon to immediately start using the application. Alternatively, you may download the [Debian package](https://github.com/daisy/ace-gui/releases/download/v1.4.6/ace-gui_1.4.6_arm64.deb) to install the app via your package manager (e.g. `sudo apt install ace-gui_1.4.6_arm64.deb`).
