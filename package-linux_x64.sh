...
yarn install --ignore-scripts --foreground-scripts --arch=x64 --cpu=x64 && cd node_modules/electron && yarn run postinstall --arch=x64 --cpu=x64 && cd - &&\
...
GITHUB_TOKEN_RELEASE_PUBLISH="xxx" CSC_NAME="" CSC_IDENTITY_AUTO_DISCOVERY="false" yarn run package:linux
...
# && file release/mac/Ace.app/Contents/MacOS/Ace
